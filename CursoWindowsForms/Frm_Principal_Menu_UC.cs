...
namespace CursoWindowsForms
{
    public partial class Frm_Principal_Menu_UC : Form
    {
        ...
        private void abrirImagemToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            Db.InitialDirectory = "C:\\Users\\lucas\\Downloads\\CursoWindowsFormsFinal\\CursoWindowsForms\\CursoWindowsForms\\Imagens";
            Db.Filter = "PNG|*.PNG";
            Db.Title = "Escolhe a imagem";
        ...
        private void conectarToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (frm_Login.DialogResult == DialogResult.OK)
            {
                ...
                if(CursoWindowsFormsBiblioteca.Cls_Uteis.ValidaSenhaLogin(login,senha) == true)
                {
                    ...
                    MessageBox.Show("Bem-Vindo, " + login.ToUpper() + "!","Mensagem",MessageBoxButtons.OK,MessageBoxIcon.Information);
                }
                else
                {
        ...
        {
            Frm_Questao Db = new Frm_Questao("icons8_ponto_de_interrogação_100", "Você deseja se desconectar?");
            Db.ShowDialog();
